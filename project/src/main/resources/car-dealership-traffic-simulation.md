[//]: # (Teraz odbywa się symulacja sytuacji, gdzie klient kupuje samochód)
...
[//]: # (Oczywiście w takim przypadku, pisząc oprogramowanie trzeba wprowadzić jakieś reguły biznesowe, żeby odzwierciedlić proces, w którym przydzielana jest praca mechanikom.)
[//]: # (Z racji, że jest to przykład edukacyjny, jest to uproszczone.)
...
[//]: # (Na koniec implementacji, dopisać jeszcze możliwość wyciągnięcia historii serwisowej auta na podstawie jego numeru VIN)
